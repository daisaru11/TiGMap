...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','jp.daisaru11.dev.tigmap.js')
	...
	f = os.path.join(cwd,'Classes','JpDaisaru11DevTigmapModuleAssets.m')
	c = open(f).read()
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','jp.daisaru11.dev.tigmap.js']
